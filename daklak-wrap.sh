...
# Keep handler at debug while letting compositor-facing logs stay quieter.
# export WAYLAND_DEBUG=1
export DAKLAK_LOG_PATH=/tmp/daklak.log
export DAKLAK_LOG_LEVEL=error
export DAKLAK_LOG_MODULES=daklak=debug,viet_ime_wayland_adapter=info,viet_ime_wayland_adapter::dispatch_v1=debug
